...
async function validateRasterResource(platform, type, source, metadata, schema) {
...
async function validateResource(platform, type, source, pipeline, errstream) {
    ...
    if (platform === "ios" /* IOS */ && type === "icon" /* ICON */) {
        if (metadata.hasAlpha) {
            ...
            errstream === null || errstream === void 0 ? void 0 : errstream.write(util_1.default.format('WARN:\tSource icon %s contains alpha channel, generated icons for %s will not.\n\n' +
...
function xpathsForPathAttribute(nodeName, attr) {
    return function xpaths(resource) {
        ...
        return [
            `${nodeName}[@${attr}='${path}']`,
            `${nodeName}[@${attr}='${path.replace(/\//g, '\\')}']`,
        ];
    };
}
exports.xpathsForPathAttribute = xpathsForPathAttribute;
 ...
 */
const WINDOWS_ICON_RESOURCES_CONFIG = {
    resources: [
 ...
 */
const WINDOWS_SPLASH_RESOURCES_CONFIG = {
    resources: [
...
const ANDROID_ADAPTIVE_ICON_RESOURCES_CONFIG = {
...
const ANDROID_ICON_RESOURCES_CONFIG = {
...
const ANDROID_SPLASH_RESOURCES_CONFIG = {
...
const IOS_ICON_RESOURCES_CONFIG = {
...
const IOS_SPLASH_RESOURCES_CONFIG = {
